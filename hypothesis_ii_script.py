...
def build_model_smoldyn(exo_rate=0.016, R_exo_rate=0.016, endo_rate=0.06, time_step=0.01, run_time=1.0, H_decay=0, filename_suffix=""):
    ...
    datafile1 = f"0.005_symmetrybreaking_iteration=1.csv"
    ...
    s.addCommand(cmd="setreactionratemolcount R_vesicle_production 0.016 0.005 FHRR(up)", cmd_type="i", on=0, off=run_time, step=0.1)
    s.addCommand(cmd="setreactionratemolcount R_vesicle_production_top 0.016 0.005 FHRR(down)", cmd_type="i", on=0, off=run_time, step=0.1)
    s.addCommand(cmd="setreactionratemolcount F_vesicle_production 0.016 -0.001 FHRR(up)", cmd_type="i", on=0, off=run_time, step=0.1)
    s.addCommand(cmd="setreactionratemolcount F_vesicle_production_top 0.016 -0.001 FHRR(up)", cmd_type="i", on=0, off=run_time, step=0.1)
